-- =============================================================================
-- SUPABASE CMS SCHEMA - Version Complètement Idempotente et Corrigée
-- =============================================================================
-- Ce script peut être exécuté plusieurs fois sans erreur
-- Vérifie l'existence de chaque élément avant de le créer
...
-- =============================================================================
-- FONCTIONS D'AIDE POUR L'IDEMPOTENCE
-- =============================================================================
...
-- =============================================================================
-- TRIGGERS POUR SLUGS AUTOMATIQUES (IDEMPOTENT)
-- =============================================================================
...
-- =============================================================================
-- TRIGGERS POUR UPDATED_AT (IDEMPOTENT)
-- =============================================================================
...
BEGIN
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'SCHEMA CMS SUPABASE CREE AVEC SUCCES - VERSION IDEMPOTENTE FINALE!';
    RAISE NOTICE '====================================================';
    ...
    RAISE NOTICE '6. Tous les delimiteurs de fonction corriges';
    RAISE NOTICE '====================================================';
...
-- Message final
SELECT 
    '✅ Schema CMS idempotent final créé avec succès!' AS status,
